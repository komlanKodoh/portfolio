  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-rose-600/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="lm-size w-full grid lg:grid-cols-12 gap-12 items-center relative z-20">
          <div className="lg:col-span-7 space-y-6">
            ...
            >
              <p className="text-2xl sm:text-3xl font-semibold text-red-500 tracking-wide">
            ...
            >
              <div className="flex flex-wrap gap-4 pt-2">
                <LinkButton
                  href="#Work"
                  className="px-8 py-3.5 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 text-white font-medium shadow-lg shadow-red-600/25 hover:opacity-95 transition-all text-sm tracking-wide"
              ...
              <div className="p-8 rounded-3xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
                ...
                <div className="space-y-4 font-mono text-sm">
                  <div className="p-3 rounded-xl bg-zinc-950/60 border border-zinc-800/50 flex justify-between items-center">
                    ...
                    <span className="text-red-400">Full-Stack & AI</span>
                  </div>
                  <div className="p-3 rounded-xl bg-zinc-950/60 border border-zinc-800/50 flex justify-between items-center">
              ...
              <div className="space-y-5">
                {skillCategories.map((group) => (
                  <div key={group.category} className="space-y-2">
                    <h4 className="text-xs font-mono tracking-wider text-red-400 uppercase">{group.category}</h4>
          ...
          <div className="space-y-12">
            ...
            <ShowProject
              project={{
                ...
                moreAbout: "/blog/scraper-copier-my-first-back-end-engineering-utility",
            ...
            <ShowProject
              project={{
                ...
                moreAbout: "/blog/kdshop-a-modern-e-commerce-solution",
        ...
        <div className="lm-size w-full max-w-4xl px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a
              ...
              className="p-6 rounded-3xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-xl hover:border-red-600/50 transition-all group flex flex-col justify-between shadow-xl"
            >
              <div className="flex items-center justify-between mb-4">
                <div className="p-3 rounded-2xl bg-zinc-950 border border-zinc-800 text-red-500">
                  <Gmail fill="currentColor" className="w-6 h-6" />
                </div>
                <span className="text-xs font-mono text-zinc-500 group-hover:text-red-400 transition-colors">Direct Mail →</span>
              </div>
              <div>

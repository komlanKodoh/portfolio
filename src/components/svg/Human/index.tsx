    ...
    >
      <g id="Human">
        ...
        <g id="Vector 1" filter="url(#filter1_d_3_5)">
          <path
            d="M150.693 516.362C39.1323 477.607 102.617 465.086 116.793 460.913L505.715 451.373C524 453.957 560.664 461.979 566.118 463.298C575.979 465.683 604.332 469.26 612.345 482.377C620.357 495.494 531.602 525.305 505.715 522.92H483.526L469.35 519.343L453.941 514.573L424.356 506.822L242.53 484.166C215.205 484.563 154.145 509.684 150.693 516.362Z"
            fill="#504848"
          />
        </g>
        <g id="Vector" filter="url(#filter2_d_3_5)">
          <path
            d="M180.784 482.338L175.72 506.56L269.89 536.984L277.366 501.234L180.784 482.338Z"
            fill="#2E2C2C"
          />
        </g>
